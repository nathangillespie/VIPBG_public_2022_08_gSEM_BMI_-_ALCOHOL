...
cd /home/projects/UKB_23704/20181126/Analyses/GWAS/20200904_AlcCons_gSEM/out
...
cd /home/ngillespie/GenomicSEM_alcohol_40PCs/
    
zcat /home/projects/UKB_23704/20181126/Analyses/GWAS/20200904_AlcCons_gSEM/out/UKB23704_AlcCons_6ageTranche_sexStrat_20210201_chr20.gz | head -1  | tr ' ' '\n' | awk '{print NR,$1}'	
...
cd /home/projects/UKB_23704/20181126/Analyses/GWAS/20200904_AlcCons_gSEM/out/
for f in UKB23704_AlcCons_6ageTranche_sexStrat_20210201_chr*.gz ; do gunzip -c "$f" > /home/ngillespie/GenomicSEM_alcohol_40PCs/"${f%.*}" ; done

#> [ngillespie@light out]$ for f in UKB23704_AlcCons_6ageTranche_sexStrat_20210201_chr*.gz ; do gunzip -c "$f" > /home/ngillespie/GenomicSEM_alcohol_40PCs/"${f%.*}" ; done
...
gunzip -c /home/projects/UKB_23704/20181126/Analyses/GWAS/20200904_AlcCons_gSEM/out/UKB23704_AlcCons_6ageTranche_sexStrat_20210201_chr19.gz > /home/ngillespie/GenomicSEM_alcohol_40PCs/UKB23704_AlcCons_6ageTranche_sexStrat_20210201_chr19
...
# GenomicSEM URL 
 ...
 # cp /home/projects/genomicSEM/test_run/*
...
# Prepare summary statistics in R
 ...
 setwd("/home/ngillespie/GenomicSEM_alcohol_40PCs/")
 require(data.table)
 ln_alc_t6_female_a		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_female_a_beta", data.table=FALSE)
 ln_alc_t6_female_b		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_female_b_beta", data.table=FALSE)
 ln_alc_t6_female_c		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_female_c_beta", data.table=FALSE)
 ln_alc_t6_female_d		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_female_d_beta", data.table=FALSE) 
 ln_alc_t6_female_e		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_female_e_beta", data.table=FALSE)  
 ln_alc_t6_female_f 	<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_female_f_beta", data.table=FALSE) 
 ln_alc_t6_male_a		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_male_a_beta", data.table=FALSE)
 ln_alc_t6_male_b		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_male_b_beta", data.table=FALSE)
 ln_alc_t6_male_c		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_male_c_beta", data.table=FALSE)
 ln_alc_t6_male_d		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_male_d_beta", data.table=FALSE) 
 ln_alc_t6_male_e		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_male_e_beta", data.table=FALSE)  
 ln_alc_t6_male_f 		<- fread("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_t6_male_f_beta", data.table=FALSE)  
...
# Extract only rows with rsIDs    
 ...
 save.image("/home/ngillespie/GenomicSEM_alcohol_40PCs/GenomicSEM_alc.RData")    
...
# Munge summary statistics files
  ...
  # https://github.com/MichelNivard/GenomicSEM/wiki/6.-GenomicSEM-and-OpenMx
   ...
   # cd /home/projects/UKB_23704/20181126/Analyses/GWAS/20200618_BMI_gSEM/out/
 ...
 qRh11 munge_alcohol.R
  ...
  setwd("/home/ngillespie/GenomicSEM_alcohol_40PCs/")
    ...
    hm3="/home/projects/genomicSEM/LD_folder/eur_w_ld_chr/w_hm3.snplist",
    trait.names=c(
...
qRh11 alc_corrs_f.R
  ...
  ld 				<- "/home/projects/genomicSEM/LD_folder/eur_w_ld_chr"
  wld 				<- "/home/projects/genomicSEM/LD_folder/eur_w_ld_chr"
  ...
  load("/Volumes/ngillespie/Documents/work/projects/2020/2020 2. genomicSEM_bmi/4. Alcohol_GWAS_results_40_PCs_separate_MFs/results/UKB23704_AlcCons_6ageTranche_sexStrat_20210201_f.RData")
...
qRh11 alc_corrs_m.R
  ...
  load("/Volumes/ngillespie/Documents/work/projects/2020/2020 2. genomicSEM_bmi/4. Alcohol_GWAS_results_40_PCs_separate_MFs/results/UKB23704_AlcCons_6ageTranche_sexStrat_20210201_m.RData")
  S2 <- as.matrix(Matrix::nearPD(LDSCoutput$S)$mat)
  round(cov2cor(S2),4)
...
# Alcohol - men + women
 ...
 qRh11 alc_corrs_mf.R
   ...
   load("/Volumes/ngillespie/Documents/work/projects/2020/2020 2. genomicSEM_bmi/4. Alcohol_GWAS_results_40_PCs_separate_MFs/results/UKB23704_AlcCons_6ageTranche_sexStrat_20210201_mf.RData")
   S2 <- as.matrix(Matrix::nearPD(LDSCoutput$S)$mat)
   round(cov2cor(S2),4)
...
# Prepare the data 
 ...
 traits 			<- c("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_a_f.sumstats.gz","/home/ngillespie/GenomicSEM_bmi_40PCs/bmi_a_f.sumstats.gz")
 sample.prev 		<- c(NA,NA)
...
# Check if GWAS sumstat p-values are standard error of logistic beta
 ...
 # Use decision tree if analyzing binary data
  ...
  head /home/ngillespie/GenomicSEM_alcohol_40PCs/UKB23704_AlcCons_6ageTranche_sexStrat_20210201_chr_allPCs_chr1to22
  
  awk '{print $2,$5,$4,$8,$11,$9}' /home/ngillespie/GenomicSEM_alcohol_40PCs/UKB23704_AlcCons_6ageTranche_sexStrat_20210201_chr_allPCs_chr1to22 | head -100  > /home/ngillespie/GenomicSEM_alcohol_40PCs/alc_100.txt
  head /home/ngillespie/GenomicSEM_alcohol_40PCs/alc_100.txt
  df <- read.table("/home/ngillespie/GenomicSEM_alcohol_40PCs/alc_100.txt",header=T)
  head(df)
...
(CleanSNPs.R)
 ...
 library(lavaan)
 setwd("/home/ngillespie/GenomicSEM_bmi_alc")
 files 			= c("/home/ngillespie/GenomicSEM_alcohol_40PCs/ln_alc_t6_female_a_withRS.txt", "/home/ngillespie/GenomicSEM_bmi_40PCs/ln_bmi_t6_female_a_withRS.txt")
